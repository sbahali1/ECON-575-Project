...
library(gap)
library(olsrr)
lin_reg_all_features = lm(real_personal_income_p ~ u6_p + ur_p + pce_inflation_p + avg_hourly_wage_p + cpi_food_p + cpi_energy_p + m2_p)
ols_step_best_subset(lin_reg_all_features)
real_personal_income_p_lag = lagged_series(real_personal_income_p, 1)
